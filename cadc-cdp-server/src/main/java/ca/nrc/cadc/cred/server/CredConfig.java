...
public class CredConfig {
    ...
    // HACK: have to hard code this because there is no good way to get a 
    // unique key, but this is only used by the docker cred app that is
    // trhe only service in the tomcat instance, so OK for now
